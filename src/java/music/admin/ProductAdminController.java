...
import music.business.AsteriskTag;
...
public class ProductAdminController extends HttpServlet {
    ...
    @Override
    public void init() {
        System.out.println("correct copy - loading flie");
...
System.out.println("In doGet - action is "+ action);
...
System.out.println("In doPost - action is " + action);
        // perform action and set URL to appropriate page
        String url = "/index.jsp";
    ...
    private String updateProduct(HttpServletRequest request,
        ...
        String url;
        if (message.isEmpty()) {
            if (ProductIO.selectProduct(product.getCode()) != null) {
